...
$this->setParameter('breadcrumbs', [
    ...
    ['label' => 'Chat', 'route' => 'chat.index', 'arguments' => ['slug' => $knowledgeBase->slug()]],
    ['label' => $conversation->title],
]);

$slug = $knowledgeBase->slug();
$askUrl = $urlGenerator->generate('chat.ask', ['slug' => $slug, 'conversationId' => $conversation->id]);
$allUrl = $urlGenerator->generate('chat.index', ['slug' => $slug]);
    ...
    <header class="chat__header">
        <div class="chat__heading">
            ...
            <p class="chat__subtitle">
                <span><?= Html::encode($knowledgeBase->name()) ?></span>
    ...
    <div class="chat__messages" role="log" aria-live="polite" aria-label="Conversation messages" tabindex="0">
        <?php if ($messages === []): ?>
            <div class="chat__empty">
                ...
                <div class="chat__examples" aria-hidden="true">
                    <span class="chat__example">What does the document say about…?</span>
                    <span class="chat__example">Summarise the key points.</span>
                    <span class="chat__example">List the important dates or names.</span>
                </div>
            </div>
        <?php else: ?>
